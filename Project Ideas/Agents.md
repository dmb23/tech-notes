# [Agent White Paper (Google)](https://www.kaggle.com/whitepaper-agents?utm_campaign=AI+Agents+In+Production+-+post+event+email+3&utm_content=AI+Agents+In+Production+-+post-event+email+2&utm_medium=JQAXBiUECA0FESwSJxsPH2MBLQ&utm_source=customer.io)

---

# [Patrick Dougherty - Building AI Aganets - Lessons learned over the past year](https://medium.com/@cpdough/building-ai-agents-lessons-learned-over-the-past-year-41dc4725d8e5) 
